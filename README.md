...
I have asked a friend to do the `how to reproduce` part, but it works on his machine. I do not understand why, since I thought guix produce reproductible builds.
